	...
	<div class="header-bot">
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 header">
				<!-- header lists -->
				<ul>
					<li><span><a href="admin/addN.jsp">发布公告</a></span></li>
					<li><span><a href="ProductServlet?method=8">物品管理</a></span></li>
	...
	<div class="operator-people">
			...
			<table class="people" border="1">
				...
				<c:forEach items="${list}" var="user">
					<tr align="center">
						...
						<td width="600px;"><a
							href="UserServlet?flag=delUser&name=${user.userName}">删除</a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
		<div class="big-foot">
			<div class="little-foot-1">
				<a href="UserServlet?p=1&flag=manage">首页</a>
			</div>
			<div class="little-foot">
				<a href="UserServlet?p=${p-1}&flag=manage">上一页</a>
			</div>
			<div class="little-foot">
				<a href="UserServlet?p=${p+1}&flag=manage">下一页</a>
			</div>
			<div class="little-foot">
				<a href="UserServlet?p=${count}&flag=manage">尾页</a>
			</div>
		</div>
	</div>
	<!-- //header-bot -->
